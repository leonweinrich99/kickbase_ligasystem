...
const MenuLink = ({ to, onClick, icon, label, color = '#8b92a5' }) => {
  const content = (
    <div className="flex items-center gap-4 bg-[#1a1d24] border border-[#2a2e37] rounded-2xl px-5 py-4 hover:border-[#3a3f4a] transition-all active:scale-[0.98]">
    ...
    <div className="min-h-screen bg-[#0f1115] p-4 sm:p-10">
      <div className="max-w-lg mx-auto">
        ...
        {isFirebaseConfigured && user && (
          <div className="flex items-center gap-4 bg-[#1a1d24] border border-[#2a2e37] rounded-2xl p-5 mb-8">
            <div className="w-14 h-14 rounded-full bg-[#20242d] border border-[#2a2e37] flex items-center justify-center overflow-hidden shrink-0">
              {user.photoURL ? (
