...
const MobileRoundView = ({ matches, isFirstRound, isFinal }) => {
  ...
  return (
    <div className="flex flex-col gap-8 mt-6 max-w-sm mx-auto pr-6 pl-6">
      {pairs.map((pair, idx) => (
        <div key={idx} className="relative flex flex-col gap-3">
          {pair[0] && (
            <div className="relative">
              {!isFirstRound && (
                <div className="absolute left-[-24px] top-1/2 w-6 border-t-2 border-[#3a3f4a] pointer-events-none"></div>
              )}
          ...
          {pair[1] && (
            <>
              <div className="absolute right-[-16px] top-[25%] bottom-[25%] w-4 border-r-2 border-t-2 border-b-2 border-[#3a3f4a] rounded-r-xl pointer-events-none"></div>
              <div className="absolute right-[-24px] top-1/2 w-2 border-t-2 border-[#3a3f4a] pointer-events-none"></div>
            </>
          )}
        </div>
      ))}
...
const Pokal = () => {
  ...
  const handleRoundChange = (round, e) => {
  ...
  return (
    <div className="max-w-[1600px] mx-auto bg-[#0f1115]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 border-b border-[#2a2e37] pb-6 gap-6 pt-4 sm:pt-0 relative">
        <div className="flex items-center gap-4 sm:gap-6 pr-32 sm:pr-0">
          ...
          <div>
            ...
            <h1 className="text-xl sm:text-3xl font-black tracking-tight uppercase">Pokalwettbewerb</h1>
          </div>
        </div>
